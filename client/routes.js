  ...
  .state('app.newpost', {
    ...
    views: {
      'menuContent@app': {
        ...
        controller: 'PostCtrl as new', //client/templates/sell/new_listing.js
        resolve: {
          user: isAuthorized
        }
      }
  ...
  .state('app.editpost', {
    ...
    views: {
      'menuContent@app': {
        ...
        controller: 'EditCtrl as edit' //client/templates/sell/edit_listing.js
      }
    }
  })
  ...
  .state('app.chat', {
    ...
    views: {
      'menuContent@app': {
        ...
        controller: 'MsgCtrl as msg' //client/templates/messages/chat.js
      }
    }
  })
  ...
  .state('app.chatinfo', {
    ...
    views: {
      'menuContent@app': {
        ...
        controller: 'MsgInfoCtrl as msg' //client/templates/messages/chat_details.js
      }
    }
  })
    ...
    views: {
      'menuContent@app': {
        resolve: {
          user: isAuthorized,
          subscribe: function() {
            return Meteor.subscribe('locationDB');
          }
        },
